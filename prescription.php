...
if ($result->num_rows==0) {
    ...
    if (mysqli_query($conn, $sql)) {
        echo"<script type='text/javascript'>window.alert(' uploaded successfully');window.location='doctor dashboard.php';</script>";
    } else {
        echo"<script type='text/javascript'>window.alert('Something went wrong :(');window.location='doctor dashboard.php';</script>";
    }
} else {
